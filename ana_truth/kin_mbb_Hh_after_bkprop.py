...
def getBSM_X2hh(mass):
      ...
      ffZ=TFile("out/pythia8_X"+str(mass)+"GeV_HH2bbll_BACKprog.root")
      hh=ffZ.Get(name)
      ...
      print("Cross=",crossZ,"fb lumi=",CurrentLumuZ," name=",name, " events=",nevents)
      Scale=ExpectedLumiFB/CurrentLumuZ;
      hh.Scale(Scale)
      hh.SetDirectory(0)
...
leg2.AddEntry(mass500,"PYTHIA8 M_{X}=0.5 - 2 TeV","lfp")
...
myText(0.49,0.85,1,0.035,intLUMI) 
...
myText(0.65,0.4,1,0.04,"After SC")
