# Plot score from backpropogation NN
...
name="Score"
xfile="out/tev13.6pp_pythia8_ttbar_2lep_BACKprog.root"
xfile=TFile( xfile )
...
for b in range(len(bmass)):
     mass=bmass[b]
     xfile1="out/pythia8_X"+str(mass)+"GeV_HH2bbll_BACKprog.root"
     xfile1=TFile( xfile1 )
     bsm=xfile1.Get(name)
...
leg3.AddEntry(ar6,"Backprop ML","l")
leg3.Draw("same")
